...
$response = $client->request('GET', '/api/Idkucing/', ['json' => [
    'id' => $id,
]]);
            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="ras" class="form-label">Ras Kucing</label>
                            <input type="text" name="ras" id="ras" class="form-control" value="<?php echo $data_body->ras ?>" required></input>
                        </div>
                        <div class="mb-3">
                            <label for="harga" class="form-label">Harga Kucing</label>
