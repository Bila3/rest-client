...
$response = $client->request('GET', '/api/Idcare/', ['json' => [
    'id' => $id,
]]);
        ...
        <div class="container-xl">
            <div class="table-responsive">
                <div class="table-wrapper">
                    ...
                    <form action="edit_data_care.php?id=<?php echo $id?>" method="POST">
                        <div class="mb-3">
                            <label for="care" class="form-label">Nama Perawatan</label>
                            <input type="text" class="form-control" id="care" name="care" value="<?php echo $data_body->care ?>" required>
                        </div>
                        <div class="mb-3">
